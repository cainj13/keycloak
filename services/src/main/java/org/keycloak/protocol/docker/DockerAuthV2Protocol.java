...
public class DockerAuthV2Protocol implements LoginProtocol {
    ...
    @Override
    public Response authenticated(final UserSessionModel userSession, final ClientSessionCode accessCode) {
    ...
    @Override
    public Response sendError(final ClientSessionModel clientSession, final LoginProtocol.Error error) {
        return new ResponseBuilderImpl().status(Response.Status.INTERNAL_SERVER_ERROR).build();
    }

    @Override
    public void backchannelLogout(final UserSessionModel userSession, final ClientSessionModel clientSession) {
        errorResponse(userSession, "backchannelLogout");
    }

    @Override
    public Response frontchannelLogout(final UserSessionModel userSession, final ClientSessionModel clientSession) {
    ...
    @Override
    public boolean requireReauthentication(final UserSessionModel userSession, final ClientSessionModel clientSession) {
        return true;
    }
